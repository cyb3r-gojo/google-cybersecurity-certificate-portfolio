# Capture your first packet using tcpdump
## Activity overview
...
ls -l capture.pcap
```
**Note:** _The "Done" in the output indicates that the packet was captured._
...
**Note:** _Hexadecimal, also known as hex or base 16, uses 16 symbols to represent values, including the digits 0-9 and letters A, B, C, D, E, and F. American Standard Code for Information Interchange (ASCII) is a character encoding standard that uses a set of characters to represent text in digital form._
